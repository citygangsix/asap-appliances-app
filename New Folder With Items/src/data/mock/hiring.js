...
export const hiringCandidates = [
  ...
  },
  {
    ...
    callHighlights:
      "Indeed candidate open to immediate work in Fort Myers and Lee County. Discussed weekday afternoon coverage and payout expectations.",
    transcriptText:
      "Hi, this is Mike. I got your resume on Indeed and wanted to offer you some work in your area. Candidate said he can cover weekday afternoons and Saturdays around Fort Myers, and he wants around one-twenty to one-fifty per completed call depending on parts complexity.",
    linkedCommunicationId: null,
  ...
  },
  {
    candidateId: "cand-2",
    name: "Erik Mendoza",
    primaryPhone: "(305) 555-0188",
    email: null,
    source: "Referral",
    stage: "documents_pending",
    trade: "Refrigeration",
    city: "Miami",
    serviceArea: "Miami / Broward",
    ...
    transcriptText:
      "We discussed his refrigeration background, Miami coverage, and the paperwork he still needs to send before we can onboard him.",
    linkedCommunicationId: null,
    providerCallSid: null,
