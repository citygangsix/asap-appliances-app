...
insert into public.customers (
  ...
  ('00000000-0000-0000-0000-000000000101', 'Renee Walker', '(352) 555-0112', null, 'renee.walker@example.com', 'Ocala', 'Marion County', 'Repeat customer', 'awaiting_callback', '2026-04-16T10:07:00Z', 1860, null, now(), now()),
  ...
  ('00000000-0000-0000-0000-000000000103', 'Bianca Flores', '(305) 555-0107', null, 'bianca.flores@example.com', 'Miami', 'Miami-Dade County', 'New customer', 'unresolved', '2026-04-16T10:37:00Z', 310, null, now(), now()),
  ('00000000-0000-0000-0000-000000000104', 'Sanjay Patel', '(954) 555-0132', null, 'sanjay.patel@example.com', 'Fort Lauderdale', 'Broward County', 'Maintenance plan', 'unread_message', '2026-04-16T10:12:00Z', 2240, null, now(), now()),
  ('00000000-0000-0000-0000-000000000105', 'Kelly Warren', '(727) 555-0159', null, 'kelly.warren@example.com', 'St. Petersburg', 'Pinellas County', 'Repeat customer', 'unresolved', '2026-04-16T10:06:00Z', 1480, null, now(), now()),
...
insert into public.jobs (
  ...
  ('00000000-0000-0000-0000-000000000301', '00000000-0000-0000-0000-000000000101', '00000000-0000-0000-0000-000000000205', 'Samsung French Door Refrigerator', 'Samsung', 'Fresh food section warm, fan noise', '4821 Cedar Crest Dr, Ocala, FL 34470', '2026-04-16T09:30:00Z', '2026-04-16T09:42:00Z', null, '2026-04-16T09:19:00Z', null, null, null, null, null, 'en_route', 'confirmed', 'parts_due', 'awaiting_payment', 'awaiting_callback', true, 'high', null, 'Quoted evap fan motor and sensor. Customer asked for callback on warranty coverage.', now(), now()),
  ('00000000-0000-0000-0000-000000000302', '00000000-0000-0000-0000-000000000102', '00000000-0000-0000-0000-000000000206', 'Whirlpool Washer', 'Whirlpool', 'Stops mid-cycle and leaves water in drum', '119 Oak Hollow Ln, Holiday, FL 34691', '2026-04-16T10:15:00Z', null, 'Onsite', null, '2026-04-16T09:41:00Z', null, null, null, null, 'onsite', 'assigned', 'labor_due', 'none_needed', 'clear', true, 'normal', null, 'Drain pump obstruction cleared. Labor invoice ready after final cycle test.', now(), now()),
  ('00000000-0000-0000-0000-000000000303', '00000000-0000-0000-0000-000000000103', null, 'GE Oven', 'GE', 'Not heating past 250 degrees', '8711 Meadow Run, Miami, FL 33142', '2026-04-16T11:00:00Z', null, 'Not set', null, null, null, null, null, null, 'scheduled', 'unassigned', 'none_due', 'quoted', 'unresolved', false, 'high', null, 'Customer requested afternoon visit if possible. Quote sent for bake element.', now(), now()),
  ('00000000-0000-0000-0000-000000000304', '00000000-0000-0000-0000-000000000104', '00000000-0000-0000-0000-000000000208', 'Bosch Dishwasher', 'Bosch', 'E15 leak code recurring', '2208 Stonegate Ct, Fort Lauderdale, FL 33301', '2026-04-16T13:15:00Z', null, '26 min late', null, null, null, null, '2026-04-15T16:45:00Z', '2026-04-16T13:15:00Z', 'return_scheduled', 'late', 'partial', 'shipped', 'unread_message', false, 'escalated', 26, 'Customer texted twice. Float switch and seal arriving today.', now(), now()),
  ...
  ('00000000-0000-0000-0000-000000000306', '00000000-0000-0000-0000-000000000106', '00000000-0000-0000-0000-000000000205', 'Frigidaire Ice Maker', 'Frigidaire', 'Not producing ice after filter change', '751 Prairie Wind, Boca Raton, FL 33432', '2026-04-16T15:30:00Z', null, 'Waiting dispatch', null, null, null, null, null, null, 'scheduled', 'escalated', 'parts_paid', 'ordered', 'clear', true, 'escalated', null, 'Window is tight because customer leaves at 5:00 PM. Dispatch decision needed now.', now(), now());
...
insert into public.invoices (
  ...
  ('00000000-0000-0000-0000-000000000401', 'INV-2042', '00000000-0000-0000-0000-000000000301', '00000000-0000-0000-0000-000000000205', 'parts_deposit', 'open', '2026-04-16', '2026-04-16', null, 'USD', 420, 0, 420, null, null, null, now(), now()),
  ('00000000-0000-0000-0000-000000000402', 'INV-2048', '00000000-0000-0000-0000-000000000302', '00000000-0000-0000-0000-000000000206', 'labor', 'open', '2026-04-16', '2026-04-16', null, 'USD', 285, 0, 285, null, null, null, now(), now()),
  ('00000000-0000-0000-0000-000000000403', 'INV-2055', '00000000-0000-0000-0000-000000000304', '00000000-0000-0000-0000-000000000208', 'parts_and_labor', 'partial', '2026-04-15', '2026-04-16', null, 'USD', 610, 260, 350, null, null, null, now(), now()),
  ('00000000-0000-0000-0000-000000000404', 'INV-2059', '00000000-0000-0000-0000-000000000305', '00000000-0000-0000-0000-000000000207', 'parts_deposit', 'failed', '2026-04-16', '2026-04-16', null, 'USD', 390, 0, 390, null, '2026-04-16T10:06:00Z', null, now(), now()),
...
insert into public.job_timeline_events (
  ...
  ('00000000-0000-0000-0000-000000000702', '00000000-0000-0000-0000-000000000301', 'technician', 'Christian Services Ocala', 'en_route', '2026-04-16T09:19:00Z', 'Technician en route', 'ETA confirmed at 12 minutes with customer updated.', '{}'::jsonb, now()),
  ('00000000-0000-0000-0000-000000000703', '00000000-0000-0000-0000-000000000302', 'technician', 'Steven Knapp', 'onsite', '2026-04-16T09:41:00Z', 'Technician onsite', 'Drain pump obstruction cleared and final test cycle started.', '{}'::jsonb, now()),
